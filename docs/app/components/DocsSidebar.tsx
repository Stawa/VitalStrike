...
const navigation: NavSection[] = [
  ...
  },
  {
    title: "Configuration",
    items: [
      { title: "Basic Settings", href: "/docs/configuration" },
    ],
  },
];
...
export default function DocsSidebar() {
  ...
  return (
    <div id="doc-menu" className="relative h-full w-full overflow-y-auto px-4 py-4">
        {navigation.map((section) => (
          <div key={section.title}>

            <p className="whitespace-nowrap py-2 text-[15px] text-gray-400 dark:text-gray-400" style={{ fontVariant: 'all-petite-caps' }}>
              {section.title}
            </p>
