      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-12 md:mb-16 lg:mb-20 px-4 md:px-6 lg:px-8">
        {guides.map((guide) => (
          ...
          >
            ...
            {/* CTA Section */}
            <div className="relative mx-4 md:mx-6 lg:mx-8 mb-8">
        <div className="rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 dark:from-primary-600 dark:to-primary-700 p-8 md:p-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-primary-100 mb-6 max-w-2xl">
              Get help, share ideas, and connect with other VitalStrike users in our Discord server.
            </p>
            <a
              href="https://discord.gg/b4nxvp8NcH"
              className="inline-flex items-center px-6 py-3 text-sm font-medium text-primary-900 dark:text-white bg-white dark:bg-white/20 hover:bg-primary-50 dark:hover:bg-white/30 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md"
            >
              Join Discord
              <svg
