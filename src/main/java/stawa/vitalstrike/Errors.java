...
/**
 * Centralized error handling for VitalStrike plugin Provides a hierarchy of custom exceptions for
...
public class Errors {
  ...
  public static class UpdateException extends CodedVitalStrikeException {
     ...
     *
     * @return true if both current and latest versions are available and different, false otherwise
     */
  ...
  /**
   * Enum representing different types of errors that can occur in VitalStrike. Each error type has
   * a unique numeric code and default message.
   */
