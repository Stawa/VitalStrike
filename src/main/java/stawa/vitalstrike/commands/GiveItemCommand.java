...
/**
 * A command executor that handles the giving of Vital Awakening items to players. This command
 * allows players with appropriate permissions to receive Vital Awakening items, which can be used
 * for self-revival when knocked down.
 */
public class GiveItemCommand implements CommandExecutor {
  ...
  /**
   * Executes the give command, providing Vital Awakening items to players. Usage: /vs
   * vitalawakening [amount]
   *
